...
#     def value(self):
#         return self._value
# In this example, the MyClass class has a single property, _value, which is initialized in the 
# init method. The value method is defined as a getter using the @property decorator, and is used
...
# through getter method.For that we need setter method which can be added by decorating method with
...
# while keeping the internal representation of the property hidden. This can be useful for encapsulation
#  and data validation.