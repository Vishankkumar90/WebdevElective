...
#     such as logging, memoization, access control, and more. They are a powerful tool that can be used 
# to make your code more readable, maintainable, and extendable